...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/dog/formWidget/>):
   1. Run `npm i`
...
- **dog.form.createError** (fired when an error occurs during dog creation)
- **dog.form.create** (fired when the dog is successfully created)
- **dog.form.updateError** (fired when an error occurs during dog update)
- **dog.form.update** (fired when the dog is successfully updated)
