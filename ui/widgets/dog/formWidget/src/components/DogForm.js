...
import { formValues, formTouched, formErrors } from 'components/__types__/dog';
...
class DogForm extends PureComponent {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <form onSubmit={handleSubmit} className={classes.root} data-testid="dog-form">
...
const formikBag = {
  mapPropsToValues: ({ dog }) => dog || emptyDog,
