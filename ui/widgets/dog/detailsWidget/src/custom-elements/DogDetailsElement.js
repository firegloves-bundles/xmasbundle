...
class DogDetailsElement extends HTMLElement {
  constructor(...args) {
    super(...args);
  ...
  render() {
    const customEventPrefix = 'dog.details.';
    ...
    const ReactComponent = React.createElement(DogDetailsContainer, {
      id,
      onError,
      serviceUrl,
    });
...
customElements.define('dog-details', DogDetailsElement);
